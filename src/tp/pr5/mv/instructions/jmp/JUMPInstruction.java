...
public class JUMPInstruction extends OneParamInstruction {
	
	public JUMPInstruction(int param) {
		this.param = param;
	}
	
	public Instruction create(int param) {
		return new JUMPInstruction(param);
	}
	...
	private static final String opcode = "JUMP";
}
