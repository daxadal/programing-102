...
public class BFInstruction extends OneParamInstruction {
	
	public BFInstruction(int param) {
		this.param = param;
	}
	
	public Instruction create(int param) {
		return new BFInstruction(param);
	}
	...
	private static final String opcode = "BF";
}
