...
public class RBTInstruction extends OneParamInstruction{

	public RBTInstruction(int param) {
		this.param = param;
	}
	
	public Instruction create(int param) {
		return new RBTInstruction(param);
	}
	...
	private static final String opcode = "RBT";
}
